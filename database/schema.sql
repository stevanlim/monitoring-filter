...
CREATE TABLE IF NOT EXISTS `tanks` (
    ...
    `estate`            VARCHAR(200)  NOT NULL DEFAULT '' COMMENT 'Nama PT / Estate',
    `location_type`     VARCHAR(100)  NOT NULL DEFAULT 'Kebun' COMMENT 'Tipe Lokasi: Kebun, Pabrikan, PKS, Gudang, dll',
    ...
    `interval_months`   INT           NOT NULL DEFAULT 90 COMMENT 'Interval servis (dalam hari/bulan)',
...
CREATE TABLE IF NOT EXISTS `maintenance_history` (
    ...
    `interval_months` INT NOT NULL DEFAULT 90,
    `notes`           TEXT NULL,
